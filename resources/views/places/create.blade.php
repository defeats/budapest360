                ...
                <div class="input-group">
                    ...
                    <div>
                        ...
                        <select id="price_range" name="price_range">
                            ...
                            <option value="2000 - 4000 Ft" {{ old('price_range') == '2000 - 4000 Ft' ? 'selected' : '' }}>
                                2000 - 4000 Ft
                            </option>
                            <option value="4000 - 6000 Ft" {{ old('price_range') == '4000 - 6000 Ft' ? 'selected' : '' }}>
                                4000 - 6000 Ft
                            </option>
                            <option value="6000 - 8000 Ft" {{ old('price_range') == '6000 - 8000 Ft' ? 'selected' : '' }}>
                                6000 - 8000 Ft
                            </option>
